**# A Flutter App For Flutter Repositories List**

## **App Feature**
- Flutter Repositories fetched from GitHub Api
- Offline caching using Hive Database
- Pagination with 10 repositories per page
- Auto refresh after 30 minutes
- Repositories can be sorted by 'Stars' and 'Update time'
...
- Tested in Android and iOS, Developed in Mac
...
- Create Module:
    ```
    get create page:module
    ```
- Create View:
    ```
    get create view:home on module
    ```
- Create Controller:
    ```
    get create controller:controller on module
    ```
