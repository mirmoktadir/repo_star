...
class MySharedPref {
  ...
  static const String _sortingKey = 'sorting';
  static const String _currentPageKey = 'currentPage';
  static const String _currentLocalKey = 'current_local';
  static const String _lightThemeKey = 'is_theme_light';

  /// sorting
  static Future setSorting(String sorting) async =>
      await _sharedPreferences!.setString(_sortingKey, sorting);

  static getSorting() => _sharedPreferences!.getString(_sortingKey);

  /// current page
  static Future setCurrentPage(String currentPage) async =>
      await _sharedPreferences!.setString(_currentPageKey, currentPage);

  static getCurrentPage() => _sharedPreferences!.getString(_currentPageKey);
  ...
  static bool getThemeIsLight() =>
      _sharedPreferences!.getBool(_lightThemeKey) ?? false;
